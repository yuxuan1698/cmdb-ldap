export default {
  ...
  'userlist_useredit_exportuser':'导出用户数据',
  ...
  'userlist_userresend_changepass':'发送用户[{username}]的修改密码邮件',
  'userlist_userresend_changepass_msg':'你确定要发送用户[{username}]的修改密码邮件?，修改密码的连接有效期为30分钟，过期失效！',
  'userlist_userresend_success':'修改密码邮件发送成功！',
